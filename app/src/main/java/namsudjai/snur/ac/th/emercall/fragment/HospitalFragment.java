...
import namsudjai.snur.ac.th.emercall.utility.HospitalAdapter;
...
//        Create ListView
        ...
        int[] ints = new int[]{R.drawable.stution1, R.drawable.station2,
                R.drawable.station3,R.drawable.station4,R.drawable.stution1,
                R.drawable.station2,R.drawable.station3,R.drawable.station4,};

        String[] titleStrings = new String[]{"Hospital 1","Hospital 2", "Hospital 3", "Hospital 4", "Hospital 5",
